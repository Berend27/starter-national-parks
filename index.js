...
function validateForm(formData) {
    ...
    if (!validateExists(formData.get("rating"))) {
        ...
        // chick if the rating is a number
...
// the previous and simple submitHandler function
// const submitHandler = (event) => {
//     event.preventDefault();

//     // Getting the inputted data with a FormData object
//     const formData = new FormData(event.target);
//     const name = formData.get("name");  // corresponds to the input's name attribute which happens to be set to "name"
//     console.log(name);
// }